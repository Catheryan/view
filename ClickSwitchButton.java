...
import android.widget.Scroller;
	 ...
	 * 开关按钮
	 */
public class ClickSwitchButton extends CompoundButton {
	    ...
	    public ClickSwitchButton(Context context) {
	        this(context, null);
	    }

	    public ClickSwitchButton(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        init(attrs);
	    }

	    public ClickSwitchButton(Context context, AttributeSet attrs, int defStyle) {
